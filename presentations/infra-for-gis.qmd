...
Nigeria - National / Country Boundaries
...
Nigeria - States / PSNUs Boundaries
...
Generate a basemap with **user provided geodata**
...
![](Graphics/Cote d'Ivoire-basemap.png){fig-align="center" width="500"}
...
![](Graphics/Screenshot - pepfar-nigeria-agency-coverage.png){width="500"}

## Thematic Maps 

There are times when **Adobe Illustrator** comes to our rescue :) 

![](Graphics/Screenshot - pepfar-zambia- geo hierarchy.png){width="500"}

## Thematic Maps 

Maps don't always tell the ful story ... add more plots and **label important elements**

![](Graphics/Screenshot - pepfar-nigeria-art-coverage.png){width="500"}

## Thematic Maps 

Be creative ... a poster might help make a better point ...

![](Graphics/Screenshot - pepfar-africa - DREAMS.png){width="1000"}
...
:::{.callout-note}
Continue to learn new things, teach them to others, and share with the world - you will sure make a difference
:::

# []{style="color:white;"} {#thankyou background-image="https://unsplash.com/photos/t48eHCSCnds/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8Mnx8dGhhbmslMjB5b3V8ZW58MHx8fHwxNjk3NDAyMTAzfDA&force=true&w=1920"}
